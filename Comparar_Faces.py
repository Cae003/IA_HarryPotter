...
imgBase = fr.load_image_file('ImagensFaces/emma.jpeg')
imgBase = cv2.cvtColor(imgBase, cv2.COLOR_BGR2RGB) #Ativar só se a imgem estiver com as cores erradas
imgTeste = fr.load_image_file('ImagensFaces/emma 2.jpeg')
...
faceLoc2 = fr.face_locations(imgTeste)[0]
cv2.rectangle(imgBase, (faceLoc[3], faceLoc[0]), (faceLoc[1], faceLoc[2]), (0,225,0), 2)
cv2.rectangle(imgTeste, (faceLoc2[3], faceLoc2[0]), (faceLoc2[1], faceLoc2[2]), (0,225,0), 2)
